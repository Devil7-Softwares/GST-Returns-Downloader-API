...
namespace Devil7.Automation.GSTR.Downloader.Utils
{
    public class PDFMakeWrapper
    {
        ...
        private void Page_Console(object sender, ConsoleEventArgs e)
        {
            ...
            {
                string[] values = value.Split(":".ToCharArray(), 3);
        ...
        public async Task GenerateGSTR1(string data, string monthValue, string filingStatus)
        {
            ...
            await page.EvaluateFunctionAsync("generateGSTR1PDF", data, filingStatus, GSTIN, monthValue, GetFinancialYear(monthValue), GetMonth(monthValue), RegisteredName, TradeName, null, null);
        }
        ...
        public async Task GenerateGSTR3B(string formDetails, string summary, string taxPayable, string monthValue, string filingStatus)
        {
            ...
            await page.EvaluateFunctionAsync("generateGSTR3BPDF", monthValue, filingStatus, summary, taxPayable, formDetails);
        }
        #endregion
    }
}
